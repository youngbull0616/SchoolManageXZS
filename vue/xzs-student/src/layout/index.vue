  ...
  <el-container>
    <el-header height="61" class="student-header">
      ...
      <el-menu class="el-menu-title" mode="horizontal" :default-active="defaultUrl" :router="true">
        ...
        <el-menu-item index="/homework/index">我的作业</el-menu-item>
        <el-menu-item index="/classroom/index">线下课程</el-menu-item>
        <el-menu-item index="/paper/index">试卷中心</el-menu-item>
        <el-menu-item index="/record/index">做题记录</el-menu-item>
    ...
    <div class="foot-copyright">
      <span>Copyright ©2024 邵磊 版权所有</span>
    </div>
  </el-container>
</template>
