...
const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'classroom/list',
        component: () => import('@/views/education/classroom/list'),
        name: 'EducationClassroomPage',
        meta: { title: '教室列表', noCache: true }
      },
      {
        path: 'classroom/edit',
        component: () => import('@/views/education/classroom/edit'),
        name: 'EducationClassroomEditPage',
        meta: { title: '教室编辑', noCache: true, activeMenu: '/education/classroom/list' },
        hidden: true
      }
    ]
  },
